...
#define inFile "data/le450_5a.txt" // Plik wejściowy

/*
nazwy plików z benchmarków : le450_5a.txt  miles250.txt  queen6.txt  myciel7.txt  le450_25a.txt  queen13.txt  myciel5.txt  miles750.txt  fpsol2.i.1.col.txt  anna.col.txt
nazwy plików wygenerowanych: gc200%25  gc400%25  gc600%25  gc800%25  gc1000%25  
                             gc200%50  gc400%50  gc600%50  gc800%50  gc1000%50  
                             gc200%75  gc400%75  gc600%75  gc800%75  gc1000%75
dodatkowe pliki: gc500.txt  gc1000.txt
*/

const int random_vertices = 60; // ilość losowo pokolorowanych wierzchołków przy tworzeniu populacji
...
vector<Specimen> tournament_selection2(vector<Specimen> chromosomes, int population) // wybór nowej populacji metodą turniejową (do nowej populacji dołączamy wylosowaną);
{
...
Specimen mutateNew2(Specimen s, int numOfColors, int numOfVertices) {  // Mutacja, nowy osobnik
    for(int i=0;i<numOfVertices;i++){
        s.colors[i] = randomNumber(0, numOfColors);
    }
    return s;
...
int main()
{
    ...
    while (iteration < iterations) {
        ...
        // chromosomes = tournament_selection(chromosomes, population); // Wybieranie nowej populacji
